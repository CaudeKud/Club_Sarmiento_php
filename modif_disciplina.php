...
if (isset($_POST['Modificar'])) {
    ...
    $sql = "UPDATE disciplinas SET disciplina = '$disciplina' WHERE id_disciplina = '$id_disciplina'";

    if (mysqli_query($conexion, $sql)) {
        $mensaje = "Disciplina modificada correctamente: " . $disciplina;
        header("Location: disciplinas.php?mensaje=" . urlencode($mensaje));
        exit();
    } else {
        echo "Error al modificar la disciplina: " . mysqli_error($conexion);
    }
}
        ...
        <section id="serDisciplina" class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 col-xl-8">
                    ...
                    ?>
                    <form action="modif_disciplina.php" method="post">
